...
# We assume Newport.ConexSAG.CommandInterface.dll is copied to our folder
clr.AddReference("Newport.SuperAGILIS.CommandInterface")
import CommandInterfaceConexSAG
...
if __name__ == '__main__':
    ...
    conex_cc = ConexSAG(com_port='com4', velocity=0.5)
