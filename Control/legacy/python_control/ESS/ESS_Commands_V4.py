...
def ESS_Open(): 
    ...
    ESS_Socket = serial.Serial('COM3', baudrate=9600, timeout=0.5) 
...
def ESS_Absolute_Move (deg): 
    ...
    #Specify the acceleration/deceleration profile: 0 for trapezoid, 1 for sinusoid. Under NO CIRCUMNSTANCES use 2!
    SendAsciiCmd(ESS_Socket,'s r0xc8 0')
    time.sleep(0.5)
