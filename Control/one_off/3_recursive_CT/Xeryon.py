...
# controller = Xeryon()
# axisX       = controller.addAxis(Stage.XLS_1_3N, "X") # Add all axis and specify the correct stage.
# axisY       = controller.addAxis(Stage.XLS_1_3N, "Y") # Add all axis and specify the correct stage.
# controller.start()
